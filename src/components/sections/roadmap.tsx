...
const NODES = [
  ...
  { title: "Platform Engineer", note: "Internal platforms · Developer experience", state: "future" },
  { title: "Agentic AI Engineer", note: "LLM orchestration · MCP · Tooling", state: "future" },
  { title: "AI Infrastructure Architect", note: "Runtimes · Scaling · Reliability", state: "north-star" },
];

export function Roadmap() {
  return (
    <Section id="roadmap" label="07 · Trajectory" title={<TypedTitle text="The path — one deployment at a time." />} meta="./roadmap.timeline">
          ...
          <li key={n.title} className="relative pb-10 last:pb-0 reveal">
            <span
              ...
              style={{
                ...
                boxShadow: n.state === "current" ? "0 0 0 4px color-mix(in oklab, var(--accent) 20%, transparent)" : undefined,
              }}
            />
            <div className="flex items-baseline gap-3">
              ...
              <span
                ...
                style={{
                  ...
                  borderColor: n.state === "current" ? "color-mix(in oklab, var(--accent) 40%, transparent)" : "var(--border)",
                }}
              >
                {n.state}
              </span>
            </div>
            <h3 className="mt-2 font-plex text-2xl md:text-3xl tracking-tight text-foreground">{n.title}</h3>
