...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aryandra Gupta — AI Infrastructure Control Center" },
      { name: "description", content: "Cloud Infrastructure Engineer · Future DevOps Engineer · Agentic AI Builder. Portfolio of Aryandra Gupta." },
      { name: "author", content: "Aryandra Gupta" },
      { name: "theme-color", content: "#0B0B0C" },
      { property: "og:title", content: "Aryandra Gupta — AI Infrastructure Control Center" },
      { property: "og:description", content: "Cloud · DevOps · Agentic AI. Portfolio of Aryandra Gupta." },
